...
module la_blas_level3_tri
     ...
     pure subroutine la_strmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_sp
...
#ifdef LA_WITH_XDP
     !> XTRMM:  performs one of the matrix-matrix operations
     !> B := alpha*op( A )*B,   or   B := alpha*B*op( A ),
     !> where  alpha  is a scalar,  B  is an m by n matrix,  A  is a unit, or
     !> non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     !> op( A ) = A   or   op( A ) = A**T.

     pure subroutine la_xtrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
     ...
     pure subroutine la_qtrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_qp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_strsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_sp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_xtrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_xdp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_qtrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_qp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_ctrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_sp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
...
#ifdef LA_WITH_XDP
     !> YTRMM:  performs one of the matrix-matrix operations
     !> B := alpha*op( A )*B,   or   B := alpha*B*op( A )
     !> where  alpha  is a scalar,  B  is an m by n matrix,  A  is a unit, or
     !> non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     !> op( A ) = A   or   op( A ) = A**T   or   op( A ) = A**H.

     pure subroutine la_ytrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_xdp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_wtrmm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_qp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_ctrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_sp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
...
#ifdef LA_WITH_XDP
     !> YTRSM:  solves one of the matrix equations
     !> op( A )*X = alpha*B,   or   X*op( A ) = alpha*B,
     !> where alpha is a scalar, X and B are m by n matrices, A is a unit, or
     !> non-unit,  upper or lower triangular matrix  and  op( A )  is one  of
     !> op( A ) = A   or   op( A ) = A**T   or   op( A ) = A**H.
     ...
     pure subroutine la_ytrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_xdp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_wtrsm(side,uplo,transa,diag,m,n,alpha,a,lda,b,ldb)
        use la_constants_qp
        ! -- reference blas level3 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end subroutine la_wtrsm
#endif

end module la_blas_level3_tri
