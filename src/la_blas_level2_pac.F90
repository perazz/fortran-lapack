...
module la_blas_level2_pac
     ...
     pure subroutine la_ssbmv(uplo,n,k,alpha,a,lda,x,incx,beta,y,incy)
        use la_constants_sp
     ...
     pure subroutine la_xsbmv(uplo,n,k,alpha,a,lda,x,incx,beta,y,incy)
     ...
     pure subroutine la_qsbmv(uplo,n,k,alpha,a,lda,x,incx,beta,y,incy)
        use la_constants_qp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_sspmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_xspmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_qspmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
        use la_constants_qp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_sspr(uplo,n,alpha,x,incx,ap)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
...
#ifdef LA_WITH_XDP
     !> XSPR:    performs the symmetric rank 1 operation
     !> A := alpha*x*x**T + A,
     !> where alpha is a real scalar, x is an n element vector and A is an
     !> n by n symmetric matrix, supplied in packed form.

     pure subroutine la_xspr(uplo,n,alpha,x,incx,ap)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_qspr(uplo,n,alpha,x,incx,ap)
        use la_constants_qp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_sspr2(uplo,n,alpha,x,incx,y,incy,ap)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
...
#ifdef LA_WITH_XDP
     !> XSPR2:  performs the symmetric rank 2 operation
     !> A := alpha*x*y**T + alpha*y*x**T + A,
     !> where alpha is a scalar, x and y are n element vectors and A is an
     !> n by n symmetric matrix, supplied in packed form.

     pure subroutine la_xspr2(uplo,n,alpha,x,incx,y,incy,ap)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_qspr2(uplo,n,alpha,x,incx,y,incy,ap)
        use la_constants_qp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_chpmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
...
#ifdef LA_WITH_XDP
     !> YHPMV:  performs the matrix-vector operation
     !> y := alpha*A*x + beta*y,
     !> where alpha and beta are scalars, x and y are n element vectors and
     !> A is an n by n hermitian matrix, supplied in packed form.

     pure subroutine la_yhpmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
              ...
              ! form  y  when ap contains the upper triangle.
               if ((incx == 1) .and. (incy == 1)) then
                   do j = 1,n
                       ...
                       y(j) = y(j) + temp1*real(ap(kk + j - 1),KIND=xdp) + alpha*temp2
                       kk = kk + j
                   end do
               else
                   jx = kx
                   ...
                   do j = 1,n
                       ...
                       y(jy) = y(jy) + temp1*real(ap(kk + j - 1),KIND=xdp) + alpha*temp2
                       jx = jx + incx
                       jy = jy + incy
                       kk = kk + j
                   end do
              ...
              ! form  y  when ap contains the lower triangle.
               if ((incx == 1) .and. (incy == 1)) then
                   do j = 1,n
                       temp1 = alpha*x(j)
                       temp2 = czero
                       y(j) = y(j) + temp1*real(ap(kk),KIND=xdp)
                       k = kk + 1
                       do i = j + 1,n
                           y(i) = y(i) + temp1*ap(k)
                           temp2 = temp2 + conjg(ap(k))*x(i)
                   ...
                   do j = 1,n
                       temp1 = alpha*x(jx)
                       temp2 = czero
                       y(jy) = y(jy) + temp1*real(ap(kk),KIND=xdp)
                       ix = jx
                       iy = jy
                       do k = kk + 1,kk + n - j
                           ix = ix + incx
     ...
     pure subroutine la_whpmv(uplo,n,alpha,ap,x,incx,beta,y,incy)
        use la_constants_qp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_chpr(uplo,n,alpha,x,incx,ap)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
...
#ifdef LA_WITH_XDP
     !> YHPR:    performs the hermitian rank 1 operation
     !> A := alpha*x*x**H + A,
     !> where alpha is a real scalar, x is an n element vector and A is an
     !> n by n hermitian matrix, supplied in packed form.

     pure subroutine la_yhpr(uplo,n,alpha,x,incx,ap)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           if (info /= 0) then
               call la_xerbla('YHPR  ',info)
               return
           end if
           ! quick return if possible.
           if ((n == 0) .or. (alpha == real(czero,KIND=xdp))) return
           ! set the start point in x if the increment is not unity.
           if (incx <= 0) then
               kx = 1 - (n - 1)*incx
           else if (incx /= 1) then
               ...
               if (incx == 1) then
                   do j = 1,n
                       if (x(j) /= czero) then
                           ...
                           ap(kk + j - 1) = real(ap(kk + j - 1),KIND=xdp) + real(x(j)*temp,KIND=xdp)
                       else
                           ap(kk + j - 1) = real(ap(kk + j - 1),KIND=xdp)
                       end if
                       kk = kk + j
                   end do
               else
                   ...
                   do j = 1,n
                       if (x(jx) /= czero) then
                           ...
                           ap(kk + j - 1) = real(ap(kk + j - 1),KIND=xdp) + real(x(jx)*temp,KIND=xdp)
              ...
              ! form  a  when lower triangle is stored in ap.
               if (incx == 1) then
                   do j = 1,n
                       if (x(j) /= czero) then
                           temp = alpha*conjg(x(j))
                           ap(kk) = real(ap(kk),KIND=xdp) + real(temp*x(j),KIND=xdp)
                           k = kk + 1
                           do i = j + 1,n
                               ap(k) = ap(k) + x(i)*temp
                               k = k + 1
                   ...
                   do j = 1,n
                       if (x(jx) /= czero) then
                           temp = alpha*conjg(x(jx))
                           ap(kk) = real(ap(kk),KIND=xdp) + real(temp*x(jx),KIND=xdp)
                           ix = jx
                           do k = kk + 1,kk + n - j
                               ix = ix + incx
                               ap(k) = ap(k) + x(ix)*temp
     ...
     pure subroutine la_whpr(uplo,n,alpha,x,incx,ap)
        use la_constants_qp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_chpr2(uplo,n,alpha,x,incx,y,incy,ap)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
...
#ifdef LA_WITH_XDP
     !> YHPR2:  performs the hermitian rank 2 operation
     !> A := alpha*x*y**H + conjg( alpha )*y*x**H + A,
     !> where alpha is a scalar, x and y are n element vectors and A is an
     !> n by n hermitian matrix, supplied in packed form.

     pure subroutine la_yhpr2(uplo,n,alpha,x,incx,y,incy,ap)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
               ...
               if ((incx == 1) .and. (incy == 1)) then
                   do j = 1,n
                       if ((x(j) /= czero) .or. (y(j) /= czero)) then
                           ...
                           ap(kk + j - 1) = real(ap(kk + j - 1),KIND=xdp) + real(x(j)*temp1 + y(j)*temp2, &
                                     KIND=xdp)
                       else
                           ap(kk + j - 1) = real(ap(kk + j - 1),KIND=xdp)
                       end if
                   ...
                   do j = 1,n
                       if ((x(jx) /= czero) .or. (y(jy) /= czero)) then
                           ...
                           ap(kk + j - 1) = real(ap(kk + j - 1),KIND=xdp) + real(x(jx)*temp1 + y(jy)*temp2, &
                                     KIND=xdp)
                       else
                           ap(kk + j - 1) = real(ap(kk + j - 1),KIND=xdp)
                       end if
               ...
               if ((incx == 1) .and. (incy == 1)) then
                   do j = 1,n
                       if ((x(j) /= czero) .or. (y(j) /= czero)) then
                           temp1 = alpha*conjg(y(j))
                           temp2 = conjg(alpha*x(j))
                           ap(kk) = real(ap(kk),KIND=xdp) + real(x(j)*temp1 + y(j)*temp2,KIND=xdp)
                   ...
                   do j = 1,n
                       if ((x(jx) /= czero) .or. (y(jy) /= czero)) then
                           temp1 = alpha*conjg(y(jy))
                           temp2 = conjg(alpha*x(jx))
                           ap(kk) = real(ap(kk),KIND=xdp) + real(x(jx)*temp1 + y(jy)*temp2,KIND=xdp)
     ...
     pure subroutine la_whpr2(uplo,n,alpha,x,incx,y,incy,ap)
        use la_constants_qp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
        ...
        ! =====================================================================
           ...
           return
     end subroutine la_whpr2
#endif

end module la_blas_level2_pac
