...
module la_inverse
...
#ifdef LA_WITH_XDP
        module procedure la_inverse_x_operator
#endif
#ifdef LA_WITH_QP
...
#ifdef LA_WITH_XDP
        module procedure la_inverse_y_operator
#endif
#ifdef LA_WITH_QP
     ...
     end subroutine la_invert_x

     ! Invert matrix in place
     function la_inverse_x(a,err) result(inva)
         !> Input matrix a[n,n]
         real(xdp),intent(in) :: a(:,:)
         !> Output matrix inverse
         real(xdp),allocatable :: inva(:,:)
         !> [optional] state return flag. On error if not requested, the code will stop
         type(la_state),optional,intent(out) :: err
         ...
         !> Compute matrix inverse
         call la_invert_x(inva,err)

     end function la_inverse_x

     ! Inverse matrix operator
     function la_inverse_x_operator(a) result(inva)
         !> Input matrix a[n,n]
         real(xdp),intent(in) :: a(:,:)
         !> Result matrix
         real(xdp),allocatable :: inva(:,:)
     ...
     end function la_inverse_x_operator
#endif
     ...
     end subroutine la_invert_y

     ! Invert matrix in place
     function la_inverse_y(a,err) result(inva)
         !> Input matrix a[n,n]
         complex(xdp),intent(in) :: a(:,:)
         !> Output matrix inverse
         complex(xdp),allocatable :: inva(:,:)
         !> [optional] state return flag. On error if not requested, the code will stop
         type(la_state),optional,intent(out) :: err
         ...
         !> Compute matrix inverse
         call la_invert_y(inva,err)

     end function la_inverse_y

     ! Inverse matrix operator
     function la_inverse_y_operator(a) result(inva)
         !> Input matrix a[n,n]
         complex(xdp),intent(in) :: a(:,:)
         !> Result matrix
         complex(xdp),allocatable :: inva(:,:)
     ...
     end function la_inverse_y_operator
#endif
