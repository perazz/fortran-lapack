              ...
              ! form  y := alpha*a**t*x + y.
               ...
               if (incx==1) then
                   ...
                   loop_120: j = 1,n
                       ...
                       ix = kx
                       k = kup1 - j
                       loop_110: i = max(1,j-ku),min(m,j+kl)
