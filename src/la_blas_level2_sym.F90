...
module la_blas_level2_sym
     ...
     pure subroutine la_ssymv(uplo,n,alpha,a,lda,x,incx,beta,y,incy)
        use la_constants_sp
     ...
     pure subroutine la_xsymv(uplo,n,alpha,a,lda,x,incx,beta,y,incy)
     ...
     pure subroutine la_ssyr(uplo,n,alpha,x,incx,a,lda)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_xsyr(uplo,n,alpha,x,incx,a,lda)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_ssyr2(uplo,n,alpha,x,incx,y,incy,a,lda)
        use la_constants_sp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
     ...
     pure subroutine la_xsyr2(uplo,n,alpha,x,incx,y,incy,a,lda)
        use la_constants_xdp
        ! -- reference blas level2 routine --
        ! -- reference blas is a software package provided by univ. of tennessee,    --
        ! -- univ. of california berkeley, univ. of colorado denver and nag ltd..--
