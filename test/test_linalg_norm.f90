...
module test_linalg_norm
    ...
    use la_constants
    use linear_algebra,only:norm,la_state
    ...
    subroutine test_vector_norms(tests)
        ...
        call add_test(tests,new_unittest("norm_s_4d",test_norm_s_4d))
        call add_test(tests,new_unittest("norm_s_5d",test_norm_s_5d))
        call add_test(tests,new_unittest("norm_s_6d",test_norm_s_6d))
        ...
        call add_test(tests,new_unittest("norm2_s_4d",test_norm2_s_4d))
        call add_test(tests,new_unittest("maxabs_s_4d",test_maxabs_s_4d))
        call add_test(tests,new_unittest("norm_dimmed_s_4d",test_norm_dimmed_s_4d))
        call add_test(tests,new_unittest("norm2_s_5d",test_norm2_s_5d))
        call add_test(tests,new_unittest("maxabs_s_5d",test_maxabs_s_5d))
        call add_test(tests,new_unittest("norm_dimmed_s_5d",test_norm_dimmed_s_5d))
        call add_test(tests,new_unittest("norm2_s_6d",test_norm2_s_6d))
        call add_test(tests,new_unittest("maxabs_s_6d",test_maxabs_s_6d))
        call add_test(tests,new_unittest("norm_dimmed_s_6d",test_norm_dimmed_s_6d))
        ...
        call add_test(tests,new_unittest("norm_d_4d",test_norm_d_4d))
        call add_test(tests,new_unittest("norm_d_5d",test_norm_d_5d))
        call add_test(tests,new_unittest("norm_d_6d",test_norm_d_6d))
        ...
        call add_test(tests,new_unittest("norm2_d_4d",test_norm2_d_4d))
        call add_test(tests,new_unittest("maxabs_d_4d",test_maxabs_d_4d))
        call add_test(tests,new_unittest("norm_dimmed_d_4d",test_norm_dimmed_d_4d))
        call add_test(tests,new_unittest("norm2_d_5d",test_norm2_d_5d))
        call add_test(tests,new_unittest("maxabs_d_5d",test_maxabs_d_5d))
        call add_test(tests,new_unittest("norm_dimmed_d_5d",test_norm_dimmed_d_5d))
        ...
        call add_test(tests,new_unittest("norm_q_3d",test_norm_q_3d))
        call add_test(tests,new_unittest("norm_q_4d",test_norm_q_4d))
        call add_test(tests,new_unittest("norm_q_5d",test_norm_q_5d))
        call add_test(tests,new_unittest("norm_q_6d",test_norm_q_6d))
        call add_test(tests,new_unittest("norm2_q_2d",test_norm2_q_2d))
        call add_test(tests,new_unittest("maxabs_q_2d",test_maxabs_q_2d))
        call add_test(tests,new_unittest("norm_dimmed_q_2d",test_norm_dimmed_q_2d))
        call add_test(tests,new_unittest("norm2_q_3d",test_norm2_q_3d))
        call add_test(tests,new_unittest("maxabs_q_3d",test_maxabs_q_3d))
        call add_test(tests,new_unittest("norm_dimmed_q_3d",test_norm_dimmed_q_3d))
        call add_test(tests,new_unittest("norm2_q_4d",test_norm2_q_4d))
        call add_test(tests,new_unittest("maxabs_q_4d",test_maxabs_q_4d))
        call add_test(tests,new_unittest("norm_dimmed_q_4d",test_norm_dimmed_q_4d))
        call add_test(tests,new_unittest("norm2_q_5d",test_norm2_q_5d))
        call add_test(tests,new_unittest("maxabs_q_5d",test_maxabs_q_5d))
        call add_test(tests,new_unittest("norm_dimmed_q_5d",test_norm_dimmed_q_5d))
        ...
        call add_test(tests,new_unittest("norm_c_4d",test_norm_c_4d))
        call add_test(tests,new_unittest("norm_c_5d",test_norm_c_5d))
        call add_test(tests,new_unittest("norm_c_6d",test_norm_c_6d))
        ...
        call add_test(tests,new_unittest("maxabs_c_4d",test_maxabs_c_4d))
        call add_test(tests,new_unittest("norm_dimmed_c_4d",test_norm_dimmed_c_4d))
        call add_test(tests,new_unittest("maxabs_c_5d",test_maxabs_c_5d))
        call add_test(tests,new_unittest("norm_dimmed_c_5d",test_norm_dimmed_c_5d))
        call add_test(tests,new_unittest("maxabs_c_6d",test_maxabs_c_6d))
        call add_test(tests,new_unittest("norm_dimmed_c_6d",test_norm_dimmed_c_6d))
        ...
        call add_test(tests,new_unittest("norm_z_4d",test_norm_z_4d))
        call add_test(tests,new_unittest("norm_z_5d",test_norm_z_5d))
        call add_test(tests,new_unittest("norm_z_6d",test_norm_z_6d))
        ...
        call add_test(tests,new_unittest("maxabs_z_4d",test_maxabs_z_4d))
        call add_test(tests,new_unittest("norm_dimmed_z_4d",test_norm_dimmed_z_4d))
        call add_test(tests,new_unittest("maxabs_z_5d",test_maxabs_z_5d))
        ...
        call add_test(tests,new_unittest("norm_w_3d",test_norm_w_3d))
        call add_test(tests,new_unittest("norm_w_4d",test_norm_w_4d))
        call add_test(tests,new_unittest("norm_w_5d",test_norm_w_5d))
        call add_test(tests,new_unittest("norm_w_6d",test_norm_w_6d))
        call add_test(tests,new_unittest("maxabs_w_2d",test_maxabs_w_2d))
        call add_test(tests,new_unittest("norm_dimmed_w_2d",test_norm_dimmed_w_2d))
        call add_test(tests,new_unittest("maxabs_w_3d",test_maxabs_w_3d))
        call add_test(tests,new_unittest("norm_dimmed_w_3d",test_norm_dimmed_w_3d))
        call add_test(tests,new_unittest("maxabs_w_4d",test_maxabs_w_4d))
        call add_test(tests,new_unittest("norm_dimmed_w_4d",test_norm_dimmed_w_4d))
        call add_test(tests,new_unittest("maxabs_w_5d",test_maxabs_w_5d))
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_s_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_s_4d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_s_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_s_5d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_s_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_s_6d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_d_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_d_4d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_d_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_d_5d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_d_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_d_6d
    ...
    subroutine test_strided_1d_q(error)
        ...
        real(qp),target :: a(n)
        real(qp),allocatable :: slice(:)
        real(qp),pointer :: twod(:,:)
        real(qp) :: rea(n)
        ...
        ! Test sliced array results
        slice = a(4:7:59)
        call check(error,abs(norm(a(4:7:59),2) - norm(slice,2)) < tol*max(1.0_qp,norm(slice,2)), &
                         'sliced real(qp) norm(a(4:7:59),2)')
        if (allocated(error)) return
        
        ! Test 2d array results
        twod(1:m,1:m) => a
        call check(error,abs(norm(twod,2) - norm(a,2)) < tol*max(1.0_qp,norm(twod,2)), &
                         '2d-reshaped real(qp) norm(a,2)')
        if (allocated(error)) return
        
        ! Test row norm (strided access)
        slice = twod(3,:)
        call check(error,abs(norm(twod(3,:),2) - norm(slice,2)) < tol*max(1.0_qp,norm(twod(3,:),2)), &
                         'row real(qp) norm(t(3,:),2)')
        if (allocated(error)) return

        ! Test column norm (strided access)
        slice = twod( :: 2,3)
        call check(error,abs(norm(twod( :: 2,3),2) - norm(slice,2)) < tol*max(1.0_qp,norm(twod( :: 2,3),2)), &
                         'column real(qp) norm(t(::2,3),2)')
        if (allocated(error)) return

    end subroutine test_strided_1d_q
    ...
    subroutine test_norm_q_1d(error)
        ...
        do order = 1,10
           write (msg,"('reshaped order-',i0,' p-norm is the same')") order
           call check(error,abs(norm(a,order) - norm(b,order)) < tol*max(1.0_qp,norm(a,order)),trim(msg))
           if (allocated(error)) return
        end do
        
        ! Infinity norms
        call check(error,abs(norm(a,'inf') - norm(b,'inf')) < tol*max(1.0_qp,norm(a,'inf')), &
                         'reshaped +infinity norm is the same')
        if (allocated(error)) return
    ...
    subroutine test_norm2_q_2d(error)
        ...
        ! Test some norms
        call check(error,abs(norm(a,2) - norm2(a)) < tol*norm(a,2), &
                         'Euclidean norm does not match real(qp) `norm2` intrinsic')
        if (allocated(error)) return
        
        ! Infinity norms
        call check(error,abs(norm(b,2) - norm2(b)) < tol*norm(b,2), &
                         'Dimmed Euclidean norm does not match real(qp) `norm2` intrinsic')
        if (allocated(error)) return
        
        ! Test norm as collapsed around dimension
        do dim = 1,ndim
            write (msg,"('Not all dim=',i0,' Euclidean norms match real(qp) `norm2` intrinsic')") dim
            call check(error,all(abs(norm(b,2,dim) - norm2(b,dim)) < tol*max(1.0_qp,norm(b,2,dim))), &
                       trim(msg))
            if (allocated(error)) return
        end do
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_q_2d(error)
        type(error_type),allocatable,intent(out) :: error
        ...
        ! Test some norms
        call check(error,abs(norm(a,'inf') - maxval(abs(a))) < tol*norm(a,'inf'), &
                         'Infinity norm does not match real(qp) `maxval(abs(.))` intrinsics')
        if (allocated(error)) return
        
        ! Infinity norms
        call check(error,abs(norm(b,'inf') - maxval(abs(b))) < tol*norm(b,'inf'), &
                         'Dimmed Infinity norm does not match real(qp) `maxval(abs(.))` intrinsics')
        if (allocated(error)) return
        
        ! Test norm as collapsed around dimension
        do dim = 1,ndim
            write (msg,"('Not all dim=',i0,' Infinity norms match real(qp) `maxval(abs(.))` intrinsics')") dim
            call check(error,all(abs(norm(b,'inf',dim) - maxval(abs(b),dim)) < tol*max(1.0_qp,norm(b,'inf',dim))), &
                       trim(msg))
            if (allocated(error)) return
        end do
        
    end subroutine test_maxabs_q_2d
    ...
    subroutine test_norm_dimmed_q_2d(error)
        ...
        do order = 1,5
           ...
           do dim = 1,ndim
               ...
               ! Assert size
               write (msg,"('dim=',i0,', order=',i0,' qp norm has the wrong shape')") dim,order
               call check(error,all(shape(bnrm) == pack(shape(b),dims /= dim)),trim(msg))
               if (allocated(error)) return
           ...
           ! Compare ND whole vector norm with unrolled vector norm
           write (msg,"('Unrolled (1d) vs 2d order=',i0,' norm')") order
           call check(error,abs(norm(a,order) - norm(b,order)) < tol*max(1.0_qp,norm(a,order)), &
                      trim(msg))
           if (allocated(error)) return
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_q_3d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_q_3d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_q_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_q_4d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_q_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_q_5d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_q_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_q_6d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_c_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_c_4d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_c_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_c_5d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_c_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_c_6d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_z_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_z_4d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_z_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_z_5d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_z_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_z_6d
    ...
    subroutine test_strided_1d_w(error)
        ...
        integer(ilp),parameter :: n = m**2
        real(qp),parameter :: tol = 10*sqrt(epsilon(0.0_qp))
        complex(qp),target :: a(n)
        complex(qp),allocatable :: slice(:)
        complex(qp),pointer :: twod(:,:)
        real(qp) :: rea(n)
        real(qp) :: ima(n)
        ...
        slice = a(4:7:59)
        call check(error,abs(norm(a(4:7:59),2) - norm(slice,2)) < tol*max(1.0_qp,norm(slice,2)), &
                         'sliced complex(qp) norm(a(4:7:59),2)')
        if (allocated(error)) return
        
        ! Test 2d array results
        twod(1:m,1:m) => a
        call check(error,abs(norm(twod,2) - norm(a,2)) < tol*max(1.0_qp,norm(twod,2)), &
                         '2d-reshaped complex(qp) norm(a,2)')
        if (allocated(error)) return
        
        ! Test row norm (strided access)
        slice = twod(3,:)
        call check(error,abs(norm(twod(3,:),2) - norm(slice,2)) < tol*max(1.0_qp,norm(twod(3,:),2)), &
                         'row complex(qp) norm(t(3,:),2)')
        if (allocated(error)) return

        ! Test column norm (strided access)
        slice = twod( :: 2,3)
        call check(error,abs(norm(twod( :: 2,3),2) - norm(slice,2)) < tol*max(1.0_qp,norm(twod( :: 2,3),2)), &
                         'column complex(qp) norm(t(::2,3),2)')
        if (allocated(error)) return

    end subroutine test_strided_1d_w
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_w_2d(error)
        type(error_type),allocatable,intent(out) :: error
        ...
        ! Test some norms
        call check(error,abs(norm(a,'inf') - maxval(abs(a))) < tol*norm(a,'inf'), &
                         'Infinity norm does not match complex(qp) `maxval(abs(.))` intrinsics')
        if (allocated(error)) return
        
        ! Infinity norms
        call check(error,abs(norm(b,'inf') - maxval(abs(b))) < tol*norm(b,'inf'), &
                         'Dimmed Infinity norm does not match complex(qp) `maxval(abs(.))` intrinsics')
        if (allocated(error)) return
        
        ! Test norm as collapsed around dimension
        do dim = 1,ndim
            write (msg,"('Not all dim=',i0,' Infinity norms match complex(qp) `maxval(abs(.))` intrinsics')") dim
            call check(error,all(abs(norm(b,'inf',dim) - maxval(abs(b),dim)) < tol*max(1.0_qp,norm(b,'inf',dim))), &
                       trim(msg))
            if (allocated(error)) return
        end do
        
    end subroutine test_maxabs_w_2d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_w_3d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_w_3d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_w_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_w_4d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_w_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_w_5d
    ...
    !> Test Infinity norm; compare with Fortran intrinsic max(abs(a))
    subroutine test_maxabs_w_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_maxabs_w_6d
