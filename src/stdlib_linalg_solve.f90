...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_ssolve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(sp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(sp),intent(in) :: b(:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_dsolve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(dp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(dp),intent(in) :: b(:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_qsolve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(qp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(qp),intent(in) :: b(:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_csolve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(sp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(sp),intent(in) :: b(:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_zsolve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(dp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(dp),intent(in) :: b(:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_wsolve_one(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(qp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(qp),intent(in) :: b(:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_ssolve_multiple(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(sp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(sp),intent(in) :: b(:,:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_dsolve_multiple(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(dp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(dp),intent(in) :: b(:,:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_qsolve_multiple(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         real(qp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         real(qp),intent(in) :: b(:,:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_csolve_multiple(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(sp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(sp),intent(in) :: b(:,:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_zsolve_multiple(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(dp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(dp),intent(in) :: b(:,:)
...
1        call linalg_error_handling(err0,err)
     ...
     ! Compute the solution to a real system of linear equations A * X = B
     pure function stdlib_linalg_wsolve_multiple(a,b,overwrite_a,err) result(x)
         !> Input matrix a[n,n]
         complex(qp),intent(inout),target :: a(:,:)
         !> Right hand side vector or array, b[n] or b[n,nrhs]
         complex(qp),intent(in) :: b(:,:)
