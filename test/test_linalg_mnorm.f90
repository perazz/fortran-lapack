module test_linalg_mnorm
    ...
    use la_constants
    use linear_algebra,only:mnorm,la_state
    ...
    subroutine test_matrix_norms(tests)
        ...
        call add_test(tests,new_unittest("test_mnorm_s_4d",test_mnorm_s_4d))
        call add_test(tests,new_unittest("test_mnorm_s_5d",test_mnorm_s_5d))
        call add_test(tests,new_unittest("test_mnorm_s_6d",test_mnorm_s_6d))
        ...
        call add_test(tests,new_unittest("test_mnorm_c_5d",test_mnorm_c_5d))
        call add_test(tests,new_unittest("test_mnorm_c_6d",test_mnorm_c_6d))
    ...
    !> Test N-D norms
    subroutine test_mnorm_s_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_s_4d
    !> Test N-D norms
    subroutine test_mnorm_s_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_s_5d
    !> Test N-D norms
    subroutine test_mnorm_s_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_s_6d
    ...
    !> Test N-D norms
    subroutine test_mnorm_d_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_d_4d
    !> Test N-D norms
    subroutine test_mnorm_d_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_d_5d
    !> Test N-D norms
    subroutine test_mnorm_d_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    subroutine test_matrix_norms_q(error)
        ...
        ! Initialize matrix with small values to avoid overflow
        A = reshape([(0.01_qp*(i - mtx_dim/2_ilp),i=1_ilp,mtx_dim*mtx_dim)], [mtx_dim,mtx_dim])
    ...
    end subroutine test_matrix_norms_q
    
    !> Test N-D norms
    subroutine test_mnorm_q_3d(error)
        type(error_type),allocatable,intent(out) :: error
        ...
        real(qp),allocatable :: a(:),b(:,:,:),one_mat(:,:)
        character(:),allocatable :: order
        ...
        do k = 1,size(orders)
            ...
            do dim1 = 1,ndim
                do dim2 = 1,ndim
                    ...
                    ! Assert size
                    write (msg,"('dim=[',i0,',',i0,'] order=',a,' qp norm returned wrong shape')") dim,order
                    call check(error,all(shape(bnrm) == pack(shape(b),dims /= dim1 .and. dims /= dim2)),trim(msg))
                    if (allocated(error)) return
                    ...
                    do l = 1,minval(shape(b))
                       ...
                       write (msg,"('dim=[',i0,',',i0,'] order=',a,' qp ',i0,'-th norm is wrong')") dim,order,l
                       call check(error,abs(one_nrm - bnrm(l)) < tol*one_nrm,trim(msg))
                       if (allocated(error)) return
                       deallocate (one_mat)
    ...
    end subroutine test_mnorm_q_3d
    !> Test N-D norms
    subroutine test_mnorm_q_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_q_4d
    !> Test N-D norms
    subroutine test_mnorm_q_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_q_5d
    !> Test N-D norms
    subroutine test_mnorm_q_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    !> Test N-D norms
    subroutine test_mnorm_c_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_c_4d
    !> Test N-D norms
    subroutine test_mnorm_c_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_c_5d
    !> Test N-D norms
    subroutine test_mnorm_c_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_c_6d
    ...
    !> Test N-D norms
    subroutine test_mnorm_z_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_z_4d
    !> Test N-D norms
    subroutine test_mnorm_z_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_z_5d
    !> Test N-D norms
    subroutine test_mnorm_z_6d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_matrix_norms_w
    
    !> Test N-D norms
    subroutine test_mnorm_w_3d(error)
        type(error_type),allocatable,intent(out) :: error
        ...
        real(qp) :: one_nrm
        real(qp),allocatable :: bnrm(:)
        complex(qp),allocatable :: a(:),b(:,:,:),one_mat(:,:)
        character(:),allocatable :: order
    ...
    end subroutine test_mnorm_w_3d
    !> Test N-D norms
    subroutine test_mnorm_w_4d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_w_4d
    !> Test N-D norms
    subroutine test_mnorm_w_5d(error)
        type(error_type),allocatable,intent(out) :: error
    ...
    end subroutine test_mnorm_w_5d
    !> Test N-D norms
    subroutine test_mnorm_w_6d(error)
        type(error_type),allocatable,intent(out) :: error
